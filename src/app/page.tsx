        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-gray-600">Generate your QR code in seconds with our intuitive interface.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Personalize your QR code with colors, logos, and custom designs.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Your data is safe with us. We use industry-standard security measures.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of users who are already creating unique QR codes.
          </p>
          <Link
            href="/create"
